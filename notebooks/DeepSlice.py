...
class DeepSlice:
    ...
    def predict(self, image_dir, prop_angles=True, huber=False, wise=False):  # input
        ...
        print(self.model)
        print(type(self.Image_generator))
        print(self.Image_generator)
        print(type(self.Image_generator.n))
        print(self.Image_generator.n)
